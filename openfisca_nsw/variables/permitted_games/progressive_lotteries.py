...
class progressive_lotteries__game_meets_criteria(Variable):
    ...
    def formula(organisation, period, parameters):
        return (
            ...
            * (organisation('progressive_lotteries__meets_criteria_for_entertainmnent_purposes', period)
            + organisation('progressive_lotteries__meets_criteria_for_whole_or_part_fundraising', period))
